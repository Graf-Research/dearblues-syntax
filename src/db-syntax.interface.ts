...
export type ObjectGrammarTableItem = ObjectGrammarTableItemPrimitive 
  | ObjectGrammarTableItemEnum
  | ObjectGrammarTableItemReference;
...
export type ObjectGrammar = ObjectGrammarTable | ObjectGrammarEnum;
